...
public class SwitchStatement {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("What is your generation:");
        String generation = s1.next();
        switch (generation) {
            case "young":
                System.out.println("you can come to my house");
//				break;
            case "old":
                System.out.println("don't come to my house");
//				break;
            default:
                System.out.println("i don't know your generation");
        }
