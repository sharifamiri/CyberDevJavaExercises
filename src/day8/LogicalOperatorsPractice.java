...
public class LogicalOperatorsPractice {
	...
	public static void main(String[] args) {
		...
		int score2 = 10;
		System.out.println(!(score2 >11));
		boolean result9 = (score>5) && !(score>11) && (score/2 ==5); //true
		boolean result10 = (score>5) && !(score <= 11) && (score/2 ==5); //false
...
//		//precedence
		int score3 = 10;
		System.out.println(score3>10 || score3==10 && score3 <5); //false
		System.out.println(score3>10 || (score3==10 && score3 <5)); //false
